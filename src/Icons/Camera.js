...
const Camera = ({ color, size, ...props }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M17.6378 7.1099C17.2648 7.1099 16.9268 6.8949 16.7678 6.5589C16.4808 5.9509 16.1158 5.1739 15.8998 4.7509C15.5808 4.1219 15.0638 3.7559 14.3478 3.7509C14.3358 3.7499 9.66382 3.7499 9.65182 3.7509C8.93582 3.7559 8.41982 4.1219 8.09982 4.7509C7.88482 5.1739 7.51982 5.9509 7.23282 6.5589C7.07382 6.8949 6.73482 7.1099 6.36282 7.1099C4.36682 7.1099 2.74982 8.7269 2.74982 10.7219V16.6579C2.74982 18.6519 4.36682 20.2699 6.36282 20.2699H17.6378C19.6328 20.2699 21.2498 18.6519 21.2498 16.6579V10.7219C21.2498 8.7269 19.6328 7.1099 17.6378 7.1099Z"
      stroke={color}
      strokeWidth="1.5"
      strokeLinecap="round"
